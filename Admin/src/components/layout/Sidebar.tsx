...
const navigation = [
  { name: 'Tổng quan', href: '/', icon: LayoutDashboard, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
  { name: 'Đơn hàng', href: '/orders', icon: ShoppingCart, roles: ['Admin', 'Staff'] },
  { name: 'Sản phẩm', href: '/products', icon: Package, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
  { name: 'Kho hàng', href: '/inventory', icon: Warehouse, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
  { name: 'Lô hàng', href: '/batches', icon: Pill, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
  { name: 'Kho chi nhánh', href: '/branch-inventory', icon: PackageSearch, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
  { name: 'Khách hàng', href: '/customers', icon: Users, roles: ['Admin'] },
  { name: 'Chi nhánh', href: '/branches', icon: Building2, roles: ['Admin'] },
  { name: 'Chuyển kho', href: '/transfers', icon: ArrowLeftRight, roles: ['Admin', 'Staff', 'WarehouseStaff'] },
          ...
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              ...
              <p className="text-xs text-sidebar-foreground truncate">
                {user?.role === 'Admin' ? 'Quản trị viên' : user?.role === 'Staff' ? 'Nhân viên' : user?.role || 'N/A'}
              </p>
            </div>
